...
export default function GameSetup() {
  ...
  return (
    <div className="flex flex-col h-full max-w-lg mx-auto px-4 pt-8">
      <div className="bg-sky-950 p-6 rounded-lg shadow-lg w-full border border-sky-600">
        <h2 className="text-2xl text-center font-semibold text-sky-600 mb-6">
          How to Play
        </h2>
        ...
        <button
          className="w-full py-3 bg-sky-600 hover:bg-cyan-600 text-white font-bold rounded-md transition-colors shadow-md disabled:bg-gray-500 disabled:cursor-not-allowed cursor-pointer"
